...
class Rainee_yql_library {
	...
	*/
	public function run_query($sql, $params = array()) {
		...
		$query_url = Rainee_yql_library::YQL_SERVICE_URL.'?'.$param_string;

		// Fire off the request
		$this->EE->load->library('rainee_curl_library');
		$curl_result = $this->EE->rainee_curl_library->do_curl($query_url);
...
/* End of file rainee_yql_library.php */
/* Location: /system/expressionengine/third_party/rainee/libraries/rainee_yql_library.php */